...
def main():
    ...
    df2 = pm_hist(df1)
    A2_1 = "Made change to pm_hist()"
    df2.to_csv(r'data2\pm_hist_right_answer.csv', index = False)
    ...
    A2_2 = 'write here'
    df_chosen = df_citcoposition.loc[(df_citcoposition['PositionDate'] == '2/24/2022')&
             (df_citcoposition['Trader'] == 'UVR')].sort_values(by='PnL', ascending=False).head(1)
